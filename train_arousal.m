...
sigmaList = [0.1:0.1:1.2, 2:10, 100:100:1000];
...
xlabel('Test Sample');
ylabel('Arousal');
title(sprintf('Kernel Smoothing arousal (Sigma = %.4f)',bestSigma));

grid on;

%% Save Model

save('KernelSmoothModel_arousal.mat',...
     'bestSigma',...
     'coeff',...
     'mu',...
     'numPC',...
